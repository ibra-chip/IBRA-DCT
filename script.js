document.addEventListener('DOMContentLoaded', () => {
	...
	const workerRosterState = { month: new Date().toISOString().slice(0, 7), query: '', statusFilter: 'all', users: [], entries: [], rendezvous: [], payouts: [], loading: false, error: null, menuWorkerId: '', detailWorkerId: '', detailMonth: '', detailSelectedDate: '', detailSnapshot: null, editingEntryId: '' };
